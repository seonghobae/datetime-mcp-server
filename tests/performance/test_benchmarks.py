...
class TestDatetimeMCPPerformance:
    ...
    def test_benchmark_get_current_datetime_iso(self, benchmark):
        ...
        def run_get_current_datetime():
            return asyncio.run(handle_call_tool("get-current-datetime", {"format": "iso"}))
    ...
    def test_benchmark_get_current_datetime_json(self, benchmark):
        ...
        def run_get_current_datetime():
            return asyncio.run(handle_call_tool("get-current-datetime", {"format": "json"}))
    ...
    def test_benchmark_calculate_date_add_days(self, benchmark):
        ...
        def run_calculate_date():
            return asyncio.run(handle_call_tool("calculate-date", {
    ...
    def test_benchmark_calculate_date_range(self, benchmark):
        ...
        def run_calculate_date_range():
            return asyncio.run(handle_call_tool("calculate-date-range", {
    ...
    def test_benchmark_calculate_business_days(self, benchmark):
        ...
        def run_calculate_business_days():
            return asyncio.run(handle_call_tool("calculate-business-days", {
    ...
    def test_benchmark_format_date(self, benchmark):
        ...
        def run_format_date():
            return asyncio.run(handle_call_tool("format-date", {
                "date": "2024-07-15",
                "format": "%Y년 %m월 %d일"
            }))
    ...
    def test_benchmark_note_operations(self, benchmark):
        ...
        def run_note_operations():
            # Add note
            asyncio.run(handle_call_tool("add-note", {
                "name": "benchmark_note",
                "content": "This is a benchmark test note."
            }))
            
            # Get note
            result = asyncio.run(handle_call_tool("get-note", {
                "name": "benchmark_note"
            }))
            
            # Delete note
            asyncio.run(handle_call_tool("delete-note", {
                "name": "benchmark_note"
            }))
...
class TestPerformanceRegression:
    ...
    def test_performance_regression_50ms_threshold(self, benchmark):
        ...
        def run_mixed_operations():
            ...
            # Calculate date
            asyncio.run(handle_call_tool("calculate-date", {
                "base_date": "2024-01-01",
                "operation": "add",
                "amount": 30,
                "unit": "days"
            ...
            asyncio.run(handle_call_tool("calculate-business-days", {
                "start_date": "2024-01-01",
                "end_date": "2024-01-31"
            }))
